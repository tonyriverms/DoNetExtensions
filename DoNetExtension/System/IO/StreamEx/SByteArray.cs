...
namespace System.IO
{
    public static partial class StreamEx
    {
        ...
        /// </param>
        public unsafe static void WriteSBytes(this Stream stream, SByte[] array, int startIndex, int count)
        {
            WriteSBytes(stream, array, startIndex, count, new byte[count * sizeof(SByte)]);
        }
        ...
        public unsafe static void WriteSBytes(this Stream stream, SByte[] array, int startIndex, int count, byte[] buffer)
        {
            fixed (SByte* ptr = array)
            {
                Marshal.Copy((IntPtr)ptr, buffer, startIndex, count);
            }
        ...
        /// <para>!!! Note this number should be no larger than the number of integers from <paramref name="startIndex" /> to the end of the array.</para></param>
        /// <param name="buffer">A byte array used to temporarily store data to write.</param>
        public unsafe static void WriteSBytes(this Stream stream, IList<SByte> array, int startIndex, int count)
        {
            WriteSBytes(stream, array, startIndex, count, new byte[sizeof(SByte) * count]);
        }
        ...
        public unsafe static void WriteSBytes(this Stream stream, SByte[] array, int startIndex = 0)
        {
            var count = array.Length - startIndex;
            WriteSBytes(stream, array, startIndex, count);
        }
        ...
        /// <param name="startIndex">A position in the array where the writing starts.</param>
        /// <param name="buffer">A byte array used to temporarily store data to write.</param>
        public unsafe static void WriteSBytes(this Stream stream, SByte[] array, byte[] buffer, int startIndex = 0)
        {
            var count = array.Length - startIndex;
            WriteSBytes(stream, array, startIndex, count, buffer);
        }
        ...
        /// <param name="startIndex">A position in the list where the writing starts.</param>
        public unsafe static void WriteSBytes(this Stream stream, IList<SByte> list, int startIndex = 0)
        {
            var count = list.Count - startIndex;
            WriteSBytes(stream, list, startIndex, count);
        }
        ...
        /// <param name="startIndex">A position in the list where the writing starts.</param>
        /// <param name="buffer">A byte array used to temporarily store data to write.</param>
        public unsafe static void WriteSBytes(this Stream stream, IList<SByte> list, byte[] buffer, int startIndex = 0)
        {
            var count = list.Count - startIndex;
            WriteSBytes(stream, list, startIndex, count, buffer);
        }
        ...
        public unsafe static SByte[] ReadSBytes(this Stream stream, int length)
        {
            var data = new SByte[length];
            var dataLen = length * sizeof(SByte);
            byte[] buffer = stream.ReadBytes(dataLen);

            fixed (SByte* lptr = data)
            {
                var bptr = (byte*)lptr;
        ...
        /// <returns>A System.SByte integer array read from the stream.</returns>
        public unsafe static SByte[] ReadSBytes(this Stream stream, int length, byte[] buffer)
        {
            var data = new SByte[length];
            var dataLen = length * sizeof(SByte);
        ...
        public static int WriteSByteArray(this Stream stream, SByte[] array, bool validityCheck = true)
        {
            var metaLen = 4;
            if (validityCheck)
            {
            ...
            stream.WriteSBytes(array);
            return metaLen + arrLen * sizeof(SByte);
        }
        ...
        /// <param name="buffer">A byte array used to temporarily store data to write.</param>
        /// <returns>The number of bytes actually written to the stream.</returns>
        public static int WriteSByteArray(this Stream stream, SByte[] array, byte[] buffer, bool validityCheck = true)
        {
            var metaLen = 4;
            if (validityCheck)
            {
            ...
            stream.WriteSBytes(array, buffer);
            return metaLen + arrLen * sizeof(SByte);
        }
        ...
        /// <summary>
        /// Reads a System.SByte integer array from this stream. The method does not require an argument specifying the length of the array; <seealso cref="ReadSBytes"/>.
        /// </summary>
        /// <param name="stream">The stream to read.</param>
        ...
        public static SByte[] ReadSByteArray(this Stream stream, bool validityCheck = true)
        {
        ...
        /// </returns>
        /// <exception cref="System.IO.InvalidDataException">Raises if data in the stream is corrupted.</exception>
        public static SByte[] ReadSByteArray(this Stream stream, byte[] buffer, bool validityCheck = true)
        {
            if (!validityCheck || stream.Check((long)37))
            {
                ...
                return stream.ReadSBytes(len, buffer);
            }
            else throw new InvalidDataException(IOResources.ERR_StreamExtension_DataIrrecognizable);
        }
        ...
        /// </returns>
        /// <exception cref="System.IO.InvalidDataException">Raises if data in the stream is corrupted.</exception>
        public static bool ReadSByteArrayToBuffer(this Stream stream, byte[] buffer, bool validityCheck = true)
        {
            if (!validityCheck || stream.Check((long)37))
            {
                var len = stream.ReadInt32(buffer);
                ...
                stream.Read(buffer, 0, len * sizeof(SByte));
                return true;
            }
            else throw new InvalidDataException(IOResources.ERR_StreamExtension_DataIrrecognizable);
        }
