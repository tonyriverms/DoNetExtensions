...
namespace System.IO
{
	public static partial class StreamEx
	{
		...
		/// </param>
		public unsafe static void WriteUInt64s(this Stream stream, UInt64[] array, int startIndex, int count)
		{
			WriteUInt64s(stream, array, startIndex, count, new byte[count * sizeof(UInt64)]);
		}
		...
		public unsafe static void WriteUInt64s(this Stream stream, UInt64[] array, int startIndex, int count, byte[] buffer)
		{
			fixed (byte* ptr = buffer)
			{
                Buffer.BlockCopy(array, 0, buffer, 0, sizeof(UInt64) * count);
			}
		...
		/// <para>!!! Note this number should be no larger than the number of integers from <paramref name="startIndex" /> to the end of the array.</para></param>
		/// <param name="buffer">A byte array used to temporarily store data to write.</param>
		public unsafe static void WriteUInt64s(this Stream stream, IList<UInt64> array, int startIndex, int count)
		{
			WriteUInt64s(stream, array, startIndex, count, new byte[sizeof(UInt64) * count]);
		}
		...
		/// <para>!!! Note this number should be no larger than the number of integers from <paramref name="startIndex" /> to the end of the array.</para></param>
		/// <param name="buffer">A byte array used to temporarily store data to write.</param>
		public unsafe static void WriteUInt64s(this Stream stream, IList<UInt64> list, int startIndex, int count, byte[] buffer)
		{
			fixed (byte* ptr = buffer) 
			{
				UInt64* iptr2 = (UInt64*)ptr;
		...
		public unsafe static void WriteUInt64s(this Stream stream, UInt64[] array, int startIndex = 0)
		{
			var count = array.Length - startIndex;
			WriteUInt64s(stream, array, startIndex, count);
		}
		...
		/// <param name="startIndex">A position in the array where the writing starts.</param>
		/// <param name="buffer">A byte array used to temporarily store data to write.</param>
		public unsafe static void WriteUInt64s(this Stream stream, UInt64[] array, byte[] buffer, int startIndex = 0)
		{
			var count = array.Length - startIndex;
			WriteUInt64s(stream, array, startIndex, count, buffer);
		}
		...
		/// <param name="startIndex">A position in the list where the writing starts.</param>
		public unsafe static void WriteUInt64s(this Stream stream, IList<UInt64> list, int startIndex = 0)
		{
			var count = list.Count - startIndex;
			WriteUInt64s(stream, list, startIndex, count);
		}
		...
		/// <param name="startIndex">A position in the list where the writing starts.</param>
		/// <param name="buffer">A byte array used to temporarily store data to write.</param>
		public unsafe static void WriteUInt64s(this Stream stream, IList<UInt64> list, byte[] buffer, int startIndex = 0)
		{
			var count = list.Count - startIndex;
			WriteUInt64s(stream, list, startIndex, count, buffer);
		}
		...
		public unsafe static UInt64[] ReadUInt64s(this Stream stream, int length)
		{
			var data = new UInt64[length];
			var dataLen = length * sizeof(UInt64);
			byte[] buffer = stream.ReadBytes(dataLen);

			fixed (UInt64* lptr = data)
			{
				var bptr = (byte*)lptr;
		...
		/// <returns>A System.UInt64 integer array read from the stream.</returns>
		public unsafe static UInt64[] ReadUInt64s(this Stream stream, int length, byte[] buffer)
		{
			var data = new UInt64[length];
			var dataLen = length * sizeof(UInt64);
		...
		public static int WriteUInt64Array(this Stream stream, UInt64[] array, bool validityCheck = true)
		{
			var metaLen = 4;
			if (validityCheck)
			{
			...
			stream.WriteUInt64s(array);
			return metaLen + arrLen * sizeof(UInt64);
		}
		...
		/// <param name="buffer">A byte array used to temporarily store data to write.</param>
		/// <returns>The number of bytes actually written to the stream.</returns>
		public static int WriteUInt64Array(this Stream stream, UInt64[] array, byte[] buffer, bool validityCheck = true)
		{
			var metaLen = 4;
			if (validityCheck)
			{
			...
			stream.WriteUInt64s(array, buffer);
			return metaLen + arrLen * sizeof(UInt64);
		}
		...
		/// <summary>
		/// Reads a System.UInt64 integer array from this stream. The method does not require an argument specifying the length of the array; <seealso cref="ReadUInt64s"/>.
		/// </summary>
		/// <param name="stream">The stream to read.</param>
		...
		public static UInt64[] ReadUInt64Array(this Stream stream, bool validityCheck = true)
		{
		...
		/// </returns>
		/// <exception cref="System.IO.InvalidDataException">Raises if data in the stream is corrupted.</exception>
		public static UInt64[] ReadUInt64Array(this Stream stream, byte[] buffer, bool validityCheck = true)
		{
			if (!validityCheck || stream.Check((long)37))
			{
				...
				return stream.ReadUInt64s(len, buffer);
			}
			else throw new InvalidDataException(IOResources.ERR_StreamExtension_DataIrrecognizable);
		}
		...
		/// </returns>
		/// <exception cref="System.IO.InvalidDataException">Raises if data in the stream is corrupted.</exception>
		public static bool ReadUInt64ArrayToBuffer(this Stream stream, byte[] buffer, bool validityCheck = true)
		{
			if (!validityCheck || stream.Check((long)37))
			{
				var len = stream.ReadInt32(buffer);
				...
				stream.Read(buffer, 0, len * sizeof(UInt64));
				return true;
			}
			else throw new InvalidDataException(IOResources.ERR_StreamExtension_DataIrrecognizable);
		}
