...
namespace System.IO
{
	public static partial class StreamEx
	{
		...
		/// </param>
		public unsafe static void WriteInt16s(this Stream stream, Int16[] array, int startIndex, int count)
		{
			WriteInt16s(stream, array, startIndex, count, new byte[count * sizeof(Int16)]);
		}
		...
		public unsafe static void WriteInt16s(this Stream stream, Int16[] array, int startIndex, int count, byte[] buffer)
		{
		...
		/// <para>!!! Note this number should be no larger than the number of integers from <paramref name="startIndex" /> to the end of the array.</para></param>
		/// <param name="buffer">A byte array used to temporarily store data to write.</param>
		public unsafe static void WriteInt16s(this Stream stream, IList<Int16> array, int startIndex, int count)
		{
			WriteInt16s(stream, array, startIndex, count, new byte[sizeof(Int16) * count]);
		}
		...
		/// <para>!!! Note this number should be no larger than the number of integers from <paramref name="startIndex" /> to the end of the array.</para></param>
		/// <param name="buffer">A byte array used to temporarily store data to write.</param>
		public unsafe static void WriteInt16s(this Stream stream, IList<Int16> list, int startIndex, int count, byte[] buffer)
		{
			fixed (byte* ptr = buffer) 
			{
				Int16* iptr2 = (Int16*)ptr;
		...
		public unsafe static void WriteInt16s(this Stream stream, Int16[] array, int startIndex = 0)
		{
			var count = array.Length - startIndex;
			WriteInt16s(stream, array, startIndex, count);
		}
		...
		/// <param name="startIndex">A position in the array where the writing starts.</param>
		/// <param name="buffer">A byte array used to temporarily store data to write.</param>
		public unsafe static void WriteInt16s(this Stream stream, Int16[] array, byte[] buffer, int startIndex = 0)
		{
			var count = array.Length - startIndex;
			WriteInt16s(stream, array, startIndex, count, buffer);
		}
		...
		/// <param name="startIndex">A position in the list where the writing starts.</param>
		public unsafe static void WriteInt16s(this Stream stream, IList<Int16> list, int startIndex = 0)
		{
			var count = list.Count - startIndex;
			WriteInt16s(stream, list, startIndex, count);
		}
		...
		/// <param name="startIndex">A position in the list where the writing starts.</param>
		/// <param name="buffer">A byte array used to temporarily store data to write.</param>
		public unsafe static void WriteInt16s(this Stream stream, IList<Int16> list, byte[] buffer, int startIndex = 0)
		{
			var count = list.Count - startIndex;
			WriteInt16s(stream, list, startIndex, count, buffer);
		}
		...
		public unsafe static Int16[] ReadInt16s(this Stream stream, int length)
		{
			var data = new Int16[length];
			var dataLen = length * sizeof(Int16);
			byte[] buffer = stream.ReadBytes(dataLen);

			fixed (Int16* lptr = data)
			{
				var bptr = (byte*)lptr;
		...
		/// <returns>A System.Int16 integer array read from the stream.</returns>
		public unsafe static Int16[] ReadInt16s(this Stream stream, int length, byte[] buffer)
		{
			var data = new Int16[length];
			var dataLen = length * sizeof(Int16);
		...
		public static int WriteInt16Array(this Stream stream, Int16[] array, bool validityCheck = true)
		{
			var metaLen = 4;
			if (validityCheck)
			{
			...
			stream.WriteInt16s(array);
			return metaLen + arrLen * sizeof(Int16);
		}
        ...
        /// <param name="buffer">A byte array used to temporarily store data to write.</param>
        /// <returns>The number of bytes actually written to the stream.</returns>
        public static int WriteInt16Array(this Stream stream, Int16[] array, byte[] buffer, bool validityCheck = true)
        {
            var metaLen = 4;
            if (validityCheck)
            {
            ...
            if (array == null)
            {
                stream.WriteInt16(0, buffer);
                return metaLen;
            }

            var arrLen = array.Length;
            stream.WriteInt32(arrLen, buffer);
            stream.WriteInt16s(array, buffer);
            return metaLen + arrLen * sizeof(Int16);
        }
		...
		/// <summary>
		/// Reads a System.Int16 integer array from this stream. The method does not require an argument specifying the length of the array; <seealso cref="ReadInt16s"/>.
		/// </summary>
		/// <param name="stream">The stream to read.</param>
		...
		public static Int16[] ReadInt16Array(this Stream stream, bool validityCheck = true)
		{
        ...
        /// </returns>
        /// <exception cref="System.IO.InvalidDataException">Raises if data in the stream is corrupted.</exception>
        public static Int16[] ReadInt16Array(this Stream stream, byte[] buffer, bool validityCheck = true)
        {
            if (!validityCheck || stream.Check((long)37))
            {
                ...
                return stream.ReadInt16s(len, buffer);
            }
            else throw new InvalidDataException(IOResources.ERR_StreamExtension_DataIrrecognizable);
        }
        ...
        /// </returns>
        /// <exception cref="System.IO.InvalidDataException">Raises if data in the stream is corrupted.</exception>
        public static bool ReadInt16ArrayToBuffer(this Stream stream, byte[] buffer, bool validityCheck = true)
        {
            if (!validityCheck || stream.Check((long)37))
            {
                var len = stream.ReadInt32(buffer);
                ...
                stream.Read(buffer, 0, len * sizeof(Int16));
                return true;
            }
            else throw new InvalidDataException(IOResources.ERR_StreamExtension_DataIrrecognizable);
        }
