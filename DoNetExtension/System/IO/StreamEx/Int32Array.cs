...
namespace System.IO
{
	public static partial class StreamEx
	{
		...
		/// </param>
		public unsafe static void WriteInt32s(this Stream stream, Int32[] array, int startIndex, int count)
		{
		...
		public unsafe static void WriteInt32s(this Stream stream, Int32[] array, int startIndex, int count, byte[] buffer)
		{
		...
		public unsafe static Int32[] ReadInt32s(this Stream stream, int length)
		{
		...
		/// <returns>A System.Int32 integer array read from the stream.</returns>
		public unsafe static Int32[] ReadInt32s(this Stream stream, int length, byte[] buffer)
		{
			var data = new Int32[length];
			var dataLen = length * sizeof(Int32);
