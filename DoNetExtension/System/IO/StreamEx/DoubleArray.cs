...
namespace System.IO
{
    public static partial class StreamEx
    {
        ...
        /// </param>
        public unsafe static void WriteDoubles(this Stream stream, Double[] array, int startIndex, int count)
        {
            WriteDoubles(stream, array, startIndex, count, new byte[count * sizeof(Double)]);
        }
        ...
        public unsafe static void WriteDoubles(this Stream stream, Double[] array, int startIndex, int count, byte[] buffer)
        {
        ...
        /// <para>!!! Note this number should be no larger than the number of integers from <paramref name="startIndex" /> to the end of the array.</para></param>
        /// <param name="buffer">A byte array used to temporarily store data to write.</param>
        public unsafe static void WriteDoubles(this Stream stream, IList<Double> array, int startIndex, int count)
        {
            WriteDoubles(stream, array, startIndex, count, new byte[sizeof(Double) * count]);
        }
        ...
        public unsafe static void WriteDoubles(this Stream stream, Double[] array, int startIndex = 0)
        {
            var count = array.Length - startIndex;
            WriteDoubles(stream, array, startIndex, count);
        }
        ...
        /// <param name="startIndex">A position in the array where the writing starts.</param>
        /// <param name="buffer">A byte array used to temporarily store data to write.</param>
        public unsafe static void WriteDoubles(this Stream stream, Double[] array, byte[] buffer, int startIndex = 0)
        {
            var count = array.Length - startIndex;
            WriteDoubles(stream, array, startIndex, count, buffer);
        }
        ...
        /// <param name="startIndex">A position in the list where the writing starts.</param>
        public unsafe static void WriteDoubles(this Stream stream, IList<Double> list, int startIndex = 0)
        {
            var count = list.Count - startIndex;
            WriteDoubles(stream, list, startIndex, count);
        }
        ...
        /// <param name="startIndex">A position in the list where the writing starts.</param>
        /// <param name="buffer">A byte array used to temporarily store data to write.</param>
        public unsafe static void WriteDoubles(this Stream stream, IList<Double> list, byte[] buffer, int startIndex = 0)
        {
            var count = list.Count - startIndex;
            WriteDoubles(stream, list, startIndex, count, buffer);
        }
        ...
        public unsafe static Double[] ReadDoubles(this Stream stream, int length)
        {
            var data = new Double[length];
            var dataLen = length * sizeof(Double);
            byte[] buffer = stream.ReadBytes(dataLen);

            fixed (Double* lptr = data)
            {
                var bptr = (byte*)lptr;
        ...
        /// <returns>A System.Double integer array read from the stream.</returns>
        public unsafe static Double[] ReadDoubles(this Stream stream, int length, byte[] buffer)
        {
            var data = new Double[length];
            var dataLen = length * sizeof(Double);
        ...
        public static int WriteDoubleArray(this Stream stream, Double[] array, bool validityCheck = true)
        {
            var metaLen = 4;
            if (validityCheck)
            {
            ...
            return metaLen + arrLen * sizeof(Double);
        }
        ...
        /// <param name="buffer">A byte array used to temporarily store data to write.</param>
        /// <returns>The number of bytes actually written to the stream.</returns>
        public static int WriteDoubleArray(this Stream stream, Double[] array, byte[] buffer, bool validityCheck = true)
        {
            var metaLen = 4;
            if (validityCheck)
            {
            ...
            stream.WriteDoubles(array, buffer);
            return metaLen + arrLen * sizeof(Double);
        }
        ...
        /// <summary>
        /// Reads a System.Double integer array from this stream. The method does not require an argument specifying the length of the array; <seealso cref="ReadDoubles"/>.
        /// </summary>
        /// <param name="stream">The stream to read.</param>
        ...
        public static Double[] ReadDoubleArray(this Stream stream, bool validityCheck = true)
        {
        ...
        /// </returns>
        /// <exception cref="System.IO.InvalidDataException">Raises if data in the stream is corrupted.</exception>
        public static Double[] ReadDoubleArray(this Stream stream, byte[] buffer, bool validityCheck = true)
        {
            if (!validityCheck || stream.Check((long)37))
            {
                ...
                return stream.ReadDoubles(len, buffer);
            }
            else throw new InvalidDataException(IOResources.ERR_StreamExtension_DataIrrecognizable);
        }
        ...
        /// </returns>
        /// <exception cref="System.IO.InvalidDataException">Raises if data in the stream is corrupted.</exception>
        public static bool ReadDoubleArrayToBuffer(this Stream stream, byte[] buffer, bool validityCheck = true)
        {
            if (!validityCheck || stream.Check((long)37))
            {
                var len = stream.ReadInt32(buffer);
                ...
                stream.Read(buffer, 0, len * sizeof(Double));
                return true;
            }
            else throw new InvalidDataException(IOResources.ERR_StreamExtension_DataIrrecognizable);
        }
