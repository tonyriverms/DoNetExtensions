...
namespace System
{
    public static partial class StringEx
    {
        ...
        /// </returns>
        public static int IndexOfNextMatch(this string str, char leftChar, char rightChar, int startIndex = 0)
        {
            var strLen = str.Length;
            ExceptionHelper.ArgumentRangeRequired<int>("startIndex", startIndex, 0, true, strLen - 1, true);
            _searchRightQuote(str, ref startIndex, strLen, leftChar, rightChar);
            return startIndex;
        }
        ...
        /// The zero-based index position of <paramref name="rightChar" /> if that character is found and it matches <paramref name="leftChar" />, or -1 if it is not.
        /// </returns>
        public static int IndexOfNextMatch(this string str, char leftChar, char rightChar, char leftQuote, char rightQuote, int startIndex = 0)
        {
            var strLen = str.Length;
            ExceptionHelper.ArgumentRangeRequired<int>("startIndex", startIndex, 0, true, strLen - 1, true);
        ...
        /// The zero-based index position of <paramref name="rightChar" /> if that character is found and it matches <paramref name="leftChar" />, or -1 if it is not.
        /// </returns>
        public static int IndexOfNextMatch(this string str, char leftChar, char rightChar, char escape, int startIndex = 0)
        {
            var strLen = str.Length;
            ExceptionHelper.ArgumentRangeRequired<int>("startIndex", startIndex, 0, true, strLen - 1, true);
        ...
        /// The zero-based index position of <paramref name="rightChar" /> if that character is found and it matches <paramref name="leftChar" />, or -1 if it is not.
        /// </returns>
        public static int IndexOfNextMatch(this string str, char leftChar, char rightChar, char[] escapes, int startIndex = 0)
        {
            var strLen = str.Length;
            ExceptionHelper.ArgumentRangeRequired<int>("startIndex", startIndex, 0, true, strLen - 1, true);
            _searchRightQuote(str, ref startIndex, strLen, leftChar, rightChar, escapes);
            return startIndex;
        }
    }
}
