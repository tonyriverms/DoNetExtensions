...
namespace System
{
    public static partial class StringEx
    {
        ...
        public static int IndexOfWithQuotes(this string str, string value, int startIndex = 0, char leftQuote = '{', char rightQuote = '}', StringComparison comparisonType = StringComparison.Ordinal)
        {
            return _innerIndexOfWithQuotes(str, value, startIndex, str.Length, leftQuote, rightQuote, comparisonType);
        }
        ...
        /// </returns>
        /// <exception cref="System.FormatException">Occurs when there is quote mismatch in the string instance.</exception>
        public static int IndexOfWithQuotes(this string str, string value, int startIndex, char[] leftQuotes, char[] rightQuotes, StringComparison comparisonType = StringComparison.Ordinal)
        {
            return _innerIndexOfWithQuotes(str, value, startIndex, str.Length, leftQuotes, rightQuotes, comparisonType);
        }
        ...
        /// </returns>
        /// <exception cref="System.FormatException">Occurs when there is quote mismatch in the string instance.</exception>
        public static StringSearchResult IndexOfAnyWithQuotes(this string str, string[] values, int startIndex = 0, char leftQuote = '{', char rightQuote = '}', StringComparison comparisonType = StringComparison.Ordinal)
        {
            return _innerIndexOfWithQuotes(str, values, startIndex, str.Length, leftQuote, rightQuote, comparisonType);
        }
        ...
        /// </returns>
        /// <exception cref="System.FormatException">Occurs when there is quote mismatch in the string instance.</exception>
        public static StringSearchResult IndexOfAnyWithQuotes(this string str, string[] values, int startIndex, char[] leftQuotes, char[] rightQuotes, StringComparison comparisonType = StringComparison.Ordinal)
        {
            return _innerIndexOfWithQuotes(str, values, startIndex, str.Length, leftQuotes, rightQuotes, comparisonType);
        }
    }
}
